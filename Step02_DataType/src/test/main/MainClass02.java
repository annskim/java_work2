...
public class MainClass02 {
	public static void main(String[] args) {
		...
		int myInt=100;
		byte myByte=100;
		// int type 변수에 있는 값은 int type 변수에 대입
		int a=myInt;
		// byte type 변수에 있는 값을 int type 변수에 대입
		int b=myByte;
		// int type 변수에 있는 값을 byte type 변수에 대입(문법 오류 발생)
		//byte c=myInt;
		 ...
		 */
		 ...
		 byte c=(byte)myInt; //굳이 넣고자 한다면 강제 casting을 하여 대입 가능  
		 // (casting type)original type 형식으로 넣으면 casting type있다고 간주됨
		 //100이 저장되어 있는 변수에 200을 대입하고
		 myInt=200;
